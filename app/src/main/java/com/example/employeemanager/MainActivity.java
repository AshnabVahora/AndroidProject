...
import com.example.employeemanager.ui.aboutUs.AboutUsFragment;
import com.example.employeemanager.ui.activity.LoginActivity;
import com.example.employeemanager.ui.contactUs.ContactUsFragment;
import com.example.employeemanager.ui.home.HomeFragment;
import com.example.employeemanager.ui.manageAdmin.ManageAdminFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void selectDrawerItem(MenuItem menuItem) {
        ...
        switch(menuItem.getItemId()) {
                ...
                txtTitle.setText("Employee Manager");
                fragmentClass = HomeFragment.class;
                break;
            case R.id.nav_manage_admin:
                //Set manage admin screen title and load manage admin fragment
                txtTitle.setText("Manage Admin");
                fragmentClass = ManageAdminFragment.class;
                break;
    ...
    private void openShareDialog() {
        ...
        String shareBody = "Let me recommend you this application Employee Management";
        sharingIntent.putExtra(android.content.Intent.EXTRA_SUBJECT, "Employee Management Application");
