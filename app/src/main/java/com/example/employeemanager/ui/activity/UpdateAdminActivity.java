...
public class UpdateAdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Load all the data from constant object
        loadDataFromConstantObject();
    ...
    private void loadDataFromConstantObject() {
        //Check if object is not null
        if(Constants.admin != null)
        {
            name.setText(Constants.admin.getFullName());
            email.setText(Constants.admin.getEmail());
            phone.setText(Constants.admin.getPhoneNumber());
            password.setText(Constants.admin.getPassword());
            companyName.setText(Constants.admin.getCompanyName());
            designation.setText(Constants.admin.getDesignation());
            address.setText(Constants.admin.getAddress());
        }
    }
    ...
    public void SetValidation() {
        ...
        if (isNameValid && isEmailValid && isPhoneValid && isPasswordValid && isCompanyValid && isDesignationValid && isAddressValid) {
            ...
            //Update static object to constants
